...
*/}}
{{- define "semaphore.mariadb.fullname" -}}
{{- include "common.names.dependency.fullname" (dict "chartName" "mariadb" "chartValues" .Values.mariadb "context" $) -}}
{{- end -}}
{{/*
Return the fullname for a dependency chart
*/}}
{{- define "common.names.dependency.fullname" -}}
{{- $chartName := .chartName }}
{{- $chartValues := .chartValues }}
{{- $context := .context }}
{{- printf "%s-%s" (include "semaphore.name" $context) (default $chartName $chartValues.nameOverride) | trunc 63 | trimSuffix "-" }}
{{- end }}
{{/*
Create a default fully qualified app name.
We truncate at 63 chars because some Kubernetes name fields are limited to this (by the DNS naming spec).
...
*/}}
{{- define "semaphore.databaseHost" -}}
{{- if .Values.mariadb.enabled }}
    {{- if eq .Values.mariadb.architecture "replication" }}
        {{- printf "%s-primary" (include "semaphore.mariadb.fullname" .) | trunc 63 | trimSuffix "-" -}}
    {{- else -}}
        {{- printf "%s" (include "semaphore.mariadb.fullname" .) -}}
    {{- end -}}
{{- else -}}
...
*/}}
{{- define "semaphore.databaseSecretName" -}}
{{- if .Values.mariadb.enabled }}
